...
const files = [
  ...
  path.join('dist-ts', 'media-share-ui.js'),
  path.join('dist-ts', 'release-notes.js'),
  path.join('dist-ts', 'report-requests-ui.js'),
  path.join('dist-ts', 'services', 'media-share.js'),
  path.join('dist-ts', 'services', 'report-requests.js'),
  ...
  path.join('tests', 'media-share.test.js'),
  path.join('tests', 'media-share-ui.test.js'),
  path.join('tests', 'release-notes.test.js'),
  path.join('tests', 'report-requests.test.js'),
  path.join('tests', 'report-requests-ui.test.js'),
  ...
  path.join('tests', 'server-backups.test.js'),
