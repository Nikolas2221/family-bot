...
export interface StorageApi {
  ...
  setPanelMessageId(messageId: string, fixedMessageId?: string): void;
  getPanelMessageId(fixedMessageId?: string): string;
  ...
  trackGuildJoin(guildId: string): void;
  trackGuildLeave(guildId: string): void;
