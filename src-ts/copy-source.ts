...
const copy: any = {
  ...
  commands: {
    ...
    artUrlDescription: 'Ссылка на изображение/GIF/Imgur или off для удаления',
  ...
  applications: {
    ...
    sent: 'Ваша заявка отправлена на рассмотрение Старшему составу семьи KLAIZ. Вердикт по заявке будет отправлен вам в личные сообщения.',
...
copy.applications.fieldNick = '🎮 Игровой никнейм | STATIC ID';
copy.applications.fieldLevel = '⚡ Лвл';
copy.applications.fieldInvite = '🫂 Кто дал инвайт / Откуда узнали';
copy.applications.fieldText = '📝 Расскажите о себе';
copy.applications.applyModalNick = 'Игровой никнейм | STATIC ID';
copy.applications.applyModalLevel = 'Игровой уровень';
copy.applications.applyModalInviter = 'Кто вас пригласил?';
copy.applications.applyModalDiscovery = 'Откуда вы узнали о нас?';
copy.applications.applyModalText = 'Расскажите о себе';
...
Object.assign(copy.applications, {
  applyModalNick: 'Игровой никнейм | STATIC ID',
  applyModalLevel: 'Игровой уровень',
  applyModalInviter: 'Кто вас пригласил?',
  applyModalDiscovery: 'Откуда вы узнали о нас?',
  applyModalText: 'Расскажите о себе',
  ...
  fieldNick: '🎮 Игровой никнейм | STATIC ID',
  fieldLevel: '⚡ Лвл',
